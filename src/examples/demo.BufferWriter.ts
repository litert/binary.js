...
const bw: $Binary.IBufferWriter = new $Binary.BufferWriter();
...
const br: $Binary.IBinaryReader = new $Binary.BufferReader(bw.truncate()); // Get the writing buffer on current position
